---
title: "Make your MLX kernels faster with the MLX Profiler"
date: "2026-07-24"
excerpt: "A quick visual guide to finding the work that actually slows down your MLX kernels."
image: "/content/blog/images/a3b-profiler-performance-ladder-no-section-number.png"
tags: ["ai", "mlx", "metal", "apple-silicon", "profiling", "kernels"]
---
...
![A profiler comparison showing fewer CPU dispatches after the A3B optimization](images/a3b-profiler-performance-ladder-no-section-number.png)

*The faster A3B path did slightly more GPU work. It won because the CPU had
less work to send.*
...
![MLX Profiler timeline before the A3B optimization, with a dense stream of CPU dispatches](images/mlx-profiler-before-v230-k1-cycle-aligned.png)

*Before: 1,976 dispatches in one active A3B decode burst.*
...
![MLX Profiler timeline after the A3B optimization, with fewer CPU dispatches and less exposed host time](images/mlx-profiler-after-pr174-k1-cycle-aligned.png)

*After: 1,459 dispatches and much less exposed CPU encoding.*
